...
print("  ")
figlet_text = pyfiglet.figlet_format("FAKE  CRAWLER", font="standard")

# Apply the neon green color to the text
colored_figlet_text = colored(figlet_text, 'green')

print(colored_figlet_text)

small_text = colored("By Anubhav and Team", 'yellow')
print(small_text)
